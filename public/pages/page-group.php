<?php
/**
 * Creates article categories (menu).
 *
...
<span class="pull-left you-are-here"> You are here : <a href="<?php echo get_site_url(); ?>/?pagename=<?php echo $option_url; ?>">Home ></a> <?php echo $term->name; ?></span>
		...
		<nav aria-label="Page navigation example">
			<ul class="bluerooster-pagination">
				<?php for($i=0;$i<$no_of_pages;$i++) { ?>
					<li class="page-item <?php if($i == $paged) { ?>pagination-active <?php } ?>"><a class="page-link" href="<?php echo get_site_url(); ?>/?pagename=<?php echo $option_url; ?>/page-group&page=<?php echo $pageid; ?>&paged=<?php echo $i;  ?>"><?php echo $i + 1; ?></a></li>
				<?php } ?>
			</ul>
		</nav>
